...
HC_money = factor(data[,8], levels = c('無','0元', '5000元以下', '5000~10000元', '5000~15000元', '10000~15000元', '15000~30000元'))
willing_pay = factor(data[,9], levels = c('0元','5000元以下','5000~10000元', '10000~15000元', '15000~30000元','30000元以上'))
bigdata_pay = factor(data[,12], levels = c('0元', '5000元以下', '5000~10000元', '5000~15000元', '10000~15000元', '15000~30000元','30000元以上'))
...
#Merge some levles.
library(spatstat)
df$HCPayment = mergeLevels(df$HCPayment, "0元"=c("無", "0元"),"5000~10000元" = c('5000~10000元', '5000~15000元'))
df$BigdataPayment = mergeLevels(df$BigdataPayment, "5000~10000元" = c('5000~10000元', '5000~15000元'))
